    ...
    public class CHCNetSDK
    {
       ...
       public enum NET_SDK_DOWNLOAD_STATUS
       {
        ...
        public struct NET_VCA_FACESNAPCFG
        {
            ...
            public ushort wFaceExposureMinDuration; //人脸曝光最短持续时间，单位：秒，范围：1~3600，默认：60
            public byte byFaceExposureMode;//人脸曝光使能：1- 关闭，2- 开启，0- 自动（根据人脸判断）
            public byte byBackgroundPic; //背景图上传使能：0- 默认值（开启），1- 禁止
            public uint dwValidFaceTime;//有效人脸最短持续时间，单位：秒
            public uint dwUploadInterval;//人脸抓拍统计数据上传间隔时间，单位：秒，默认为900秒
            public uint dwFaceFilteringTime;//人脸停留时间过滤，取值范围：0~100，单位：秒，默认为5秒，0秒表示不过滤
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 84, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;
        }
